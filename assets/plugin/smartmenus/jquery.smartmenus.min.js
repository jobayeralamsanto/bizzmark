  ...
  return (
    ...
    $.extend($.SmartMenus, {
      ...
      prototype: {
        ...
        // },
        isCSSOn: function () {
          // Check if this.$firstLink is null before accessing its properties
          if (this.$firstLink !== null && typeof this.$firstLink !== "undefined") {
            return "inline" != this.$firstLink.css("display");
          } else {
            // Handle the case where this.$firstLink is null or undefined
        ...
        menuPosition: function (t) {
          ...
          t.css({ top: "auto", right: "0", marginLeft: e, marginTop: i - m });
        },
        ...
        menuShow: function (t) {
          if ((t.dataSM("beforefirstshowfired") || (t.dataSM("beforefirstshowfired", !0), this.$root.triggerHandler("beforefirstshow.smapi", t[0]) !== !1)) && this.$root.triggerHandler("beforeshow.smapi", t[0]) !== !1 && (t.dataSM("shown-before", !0), canAnimate && t.stop(!0, !0), !t.is(":visible"))) {
            ...
            if (((this.opts.keepHighlighted || i) && e.addClass("highlighted"), i)) t.removeClass("sm-nowrap").css({ zIndex: "", width: "auto", minWidth: "", maxWidth: "", top: "", rigit: "", marginLeft: "", marginTop: "" });
            else {
